...
_Note: Record types are [nominal](https://en.wikipedia.org/wiki/Nominal_type_system#:~:text=Nominal%20typing%20means%20that%20two,declarations%20name%20the%20same%20type.). This has some important consequences
...
Records do support mutable fields, and this is how [Mutable Bindings](mutable-bindings.md)
are implemented:
